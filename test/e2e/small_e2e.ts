...
export function runE2ETests() {
  ...
  minifier.renameProgram(['./test/input/external_call_site.ts', './node_modules/typescript/bin/typescript.d.ts'], './build/output');
  ...
  require('../../output/test/input/external_call_site.js');
